...
def compare_records(azara_record, rui_record):
    ...
    """
    a_cordinate = convert_coordinate(azara_record[1])
    r_cordinate = rui_record[1]
    return a_cordinate == r_cordinate
...
def clean_up(combined_record_group):
    ...
    for record in combined_record_group:
        cleaned_r = record[:1] + record[2:]
        combine_record += f"{cleaned_r}\n"
